...
const Navbar = () => {
  ...
  const NavItems = () => (
    <>
      <li className="hover:shadow-sm hover:shadow-[#bc98fd8c] p-2 active:bg-[#bc98fd8c] active:text-black active:shadow-lg">
        <Link to="/">Home</Link>
      </li>
      <li className="hover:shadow-sm hover:shadow-[#bc98fd8c] p-2 active:bg-[#bc98fd8c] active:text-black active:shadow-lg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link
              to="/Login"
              className="border-2 px-5 py-1 rounded-lg bg-gradient-to-r from-[#f5f7fa] via-[#eaeef5] to-[#c3cfe2] hover:shadow-xl hover:shadow-[#f0f1f2]"
            >
              Login
            </Link>
            <Link
